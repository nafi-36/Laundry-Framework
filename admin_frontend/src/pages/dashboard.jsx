...
export default class Home extends React.Component {
    constructor() {
        ...
        if (localStorage.getItem('token')) {
            ...
            this.state.adminName = localStorage.getItem('admin_name')
            this.state.adminRole = localStorage.getItem('role')
                                ...
                                <div className="col-md-12 grid-margin">
                                    <div className="row">
                                        <div className="col-12 col-xl-8 mb-4 mb-xl-0">
                                            <h3 className="font-weight-bold">Hi! Welcome {this.state.adminRole} {this.state.adminName}</h3>
                                            ...
                                            <div className="justify-content-end d-flex">
                                                <div className="dropdown flex-md-grow-1 flex-xl-grow-0">
                                                    <button className="btn btn-sm btn-light bg-white" type="button" id="dropdownMenuDate2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                                        <i className="mdi mdi-calendar"></i>Outlet : {this.state.outlet.name}, {this.state.outlet.address}
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="card-people mt-auto">
                                            ...
                                            <div className="weather-info">
                                                <div className="d-flex">
                                                    ...
                                                    <div className="ml-2">
                                                        <h4 className="location font-weight-normal">{this.state.outlet.address}</h4>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-4 stretch-card transparent">
                                            <div className="card card-tale">
                                                <div className="card-body">
                                                    ...
                                                    <div className="row">
                                                        <div className="col-3"><Person sx={{ fontSize: 30 }} className="text-white" /></div>
                                                        <div className="col-9"><p className="fs-30 mb-3">{this.state.adminCount}</p></div>
                                                    </div>
                                                    <p>100%</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-md-6 mb-4 stretch-card transparent">
                                            <div className="card card-dark-blue">
                                                <div className="card-body">
                                                    <p className="mb-4">Customer Total</p>
                                                    <div className="row">
                                                        <div className="col-3"><People sx={{ fontSize: 30 }} className="text-white" /></div>
                                                        <div className="col-9"><p className="fs-30 mb-3">{this.state.customerCount}</p></div>
                                                    </div>
                                                    <p>100%</p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-4 mb-lg-0 stretch-card transparent">
                                            <div className="card card-light-blue">
                                                <div className="card-body">
                                                    <p className="mb-4">Laundry Packet Total</p>
                                                    <div className="row">
                                                        <div className="col-3"><Packet sx={{ fontSize: 30 }} className="text-white" /></div>
                                                        <div className="col-9"><p className="fs-30 mb-3">{this.state.paketCount}</p></div>
                                                    </div>
                                                    <p>100%</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="col-md-6 stretch-card transparent">
                                            <div className="card card-light-danger">
                                                <div className="card-body">
                                                    <p className="mb-4">Outlet Total</p>
                                                    <div className="row">
                                                        <div className="col-3"><Outlet sx={{ fontSize: 30 }} className="text-white" /></div>
                                                        <div className="col-9"><p className="fs-30 mb-3">{this.state.outletCount}</p></div>
                                                    </div> 
                                                    <p>100%</p>
                                                </div>
                                            </div>
